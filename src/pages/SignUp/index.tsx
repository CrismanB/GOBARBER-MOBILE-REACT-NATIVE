...
import { Container, Title, ToSignInButton, ToSignInButtonText } from "./styles";
...
const SignUp: React.FC = () => {
  ...
  return (
    <>
      ...
      <ToSignInButton onPress={() => navigation.goBack()}>
        <Icon name="arrow-left" size={20} color="#fff" />
        <ToSignInButtonText>Voltar para logon</ToSignInButtonText>
      </ToSignInButton>
    </>
  );
};
